			...
			<div id="board">
				...
				<table class="tbl-ex">
					...
					<tr>
						...
						<a href="${pageContext.request.contextPath}/board/delete/${vo.id }" class="del"
				...
				<div class="pager">
					...
					<ul>
						<c:if test="${map.page > 1}">
							<li><a href="${pageContext.request.contextPath }/board/${map.page - 1}">◀</a></li>
						</c:if>

						<c:forEach begin="${map.startPage }" end="${map.startPage + 4 }" step="1" var="i">
						<li class="${i == map.page ? 'selected' : ''}">

						<c:choose>
    						<c:when test="${i <= map.endPage}">
